...
public interface MultipleChoiceQuestionRepository extends JpaRepository<MultipleChoiceQuestion, String> {
    @Query("SELECT q FROM MultipleChoiceQuestion q WHERE q.channel = :channel AND " +
    ...
    Page<MultipleChoiceQuestion> search(@Param("channel") String channel, @Param("question") String question,
            @Param("lang") MultipleChoiceQuestion.Language lang, @Param("tags") String tags, @Param("isActive") Boolean isActive,
    ...
    List<MultipleChoiceQuestion> findAll(@Param("channel") String channel, @Param("question") String question,
            @Param("lang") MultipleChoiceQuestion.Language lang, @Param("tags") String tags, @Param("isActive") Boolean isActive,
            @Param("term") Integer term, @Param("week") Integer week, @Param("difficultyLevel") String difficultyLevel,
