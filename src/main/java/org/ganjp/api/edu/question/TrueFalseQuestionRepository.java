...
public interface TrueFalseQuestionRepository extends JpaRepository<TrueFalseQuestion, String> {
    @Query("SELECT q FROM TrueFalseQuestion q WHERE q.channel = :channel AND " +
    ...
    Page<TrueFalseQuestion> search(@Param("channel") String channel, @Param("question") String question,
            @Param("lang") TrueFalseQuestion.Language lang, @Param("tags") String tags, @Param("isActive") Boolean isActive,
    ...
    List<TrueFalseQuestion> findAll(@Param("channel") String channel, @Param("question") String question,
            @Param("lang") TrueFalseQuestion.Language lang, @Param("tags") String tags, @Param("isActive") Boolean isActive,
            @Param("term") Integer term, @Param("week") Integer week, @Param("difficultyLevel") String difficultyLevel,
