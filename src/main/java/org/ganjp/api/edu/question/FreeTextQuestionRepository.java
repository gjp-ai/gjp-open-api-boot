...
public interface FreeTextQuestionRepository extends JpaRepository<FreeTextQuestion, String> {
    @Query("SELECT q FROM FreeTextQuestion q WHERE q.channel = :channel AND " +
    ...
    Page<FreeTextQuestion> search(@Param("channel") String channel, @Param("question") String question,
            @Param("lang") FreeTextQuestion.Language lang, @Param("tags") String tags, @Param("isActive") Boolean isActive,
    ...
    List<FreeTextQuestion> findAll(@Param("channel") String channel, @Param("question") String question,
            @Param("lang") FreeTextQuestion.Language lang, @Param("tags") String tags, @Param("isActive") Boolean isActive,
            @Param("term") Integer term, @Param("week") Integer week, @Param("difficultyLevel") String difficultyLevel,
