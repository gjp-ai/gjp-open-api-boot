...
@RestController
@RequestMapping("/open/edu-free-text-questions")
@RequiredArgsConstructor
public class FreeTextQuestionController {
    private final FreeTextQuestionService service;
    ...
    public ApiResponse<PaginatedResponse<EduQuestionResponse>> getQuestions(@RequestParam String channel,
        ...
        FreeTextQuestion.Language language = CmsUtil.parseLanguage(lang, FreeTextQuestion.Language.class);
        ...
        return ApiResponse.success(service.getQuestions(channel, question, language, tags, isActive, term, week,
                difficultyLevel, gradeLevel, subject, topic, page, size, sort, direction), "Free text questions retrieved");
    }
    ...
    public ApiResponse<List<EduQuestionResponse>> getAllQuestions(@RequestParam String channel,
        ...
        return ApiResponse.success(service.getAllQuestions(channel, question, language, tags, isActive, term, week,
                difficultyLevel, gradeLevel, subject, topic, updatedAfter), "All free text questions retrieved");
    }
    ...
    public ApiResponse<EduQuestionResponse> getQuestionById(@PathVariable String id) {
        ...
        return response == null ? ApiResponse.error(404, "Free text question not found", null)
                : ApiResponse.success(response, "Free text question retrieved");
    }
    ...
    public ApiResponse<EduQuestionResponse> toggleFavoriteTag(@PathVariable String id) {
        ...
        return response == null ? ApiResponse.error(404, "Free text question not found", null)
                : ApiResponse.success(response, "Free text question favorite tag updated");
    }
}
